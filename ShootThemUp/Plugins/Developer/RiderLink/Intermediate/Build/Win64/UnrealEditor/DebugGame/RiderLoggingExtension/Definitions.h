...
#define UE_PROJECT_NAME ShootThemUp
#define UE_TARGET_NAME ShootThemUpEditor
#define UE_MODULE_NAME "RiderLoggingExtension"
...
#define RIDERBLUEPRINTEXTENSION_API DLLIMPORT
#define RIDERLOGGINGEXTENSION_API DLLEXPORT
